...
<?php
        ...
        $numero = $_SESSION['id'];
        $query="select * from ingles where idingles='$numero'";
...
?>" required>
  	...
  	<div class="input-group">
  		<button type="submit" class="btn btn-info btn-lg" name="ingles_editar">Cambiar datos</button>
  	</div>
      	<p>
         <a href="index-admin.php#!/Ingles">¿Deseas regresar?</a>
  	</p>
  </form>
</div>