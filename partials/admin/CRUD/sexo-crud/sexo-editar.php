...
<?php
        ...
        $numero = $_SESSION['id'];
        $query="select * from sexo where idsexo='$numero'";
...
?>" required>
  	...
  	<div class="input-group">
  		<button type="submit" class="btn btn-info btn-lg" name="sexo_editar">Cambiar datos</button>
  	</div>
      	<p>
         <a href="index-admin.php#!/Sexo">¿Deseas regresar?</a>
  	</p>
  </form>
</div>